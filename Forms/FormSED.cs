...
{
    public partial class FormSED : Form
    {
        public FormSED()
        {
            InitializeComponent();
            //MessageBox.Show("Please enter your chosen excel file and choose a sheet. Thank you!", "To proceed to SED Department", MessageBoxButtons.OK);
        }


        private void FormSED_Load(object sender, EventArgs e)
        {
        ...
        private void cboSheet_SelectionChangeCommitted(object sender, EventArgs e)
        {
            ...
            //dv.RowFilter = "Department = 'SED'"; //FILTER DEPARTMENT
        ...
        private void buttonExport_Click(object sender, EventArgs e)
        {
            ...
            // save the excel file
            workbook.SaveAs("C:\\Users\\" + serverName + "\\Downloads\\SED-Output.xlsx" + "-" + localDate + ".xlsx", Type.Missing, Type.Missing, Type.Missing, Type.Missing, Type.Missing, Microsoft.Office.Interop.Excel.XlSaveAsAccessMode.xlExclusive, Type.Missing, Type.Missing, Type.Missing, Type.Missing);
